...
# d = pd.read('qfq.xlsx')
# df = pd.read_excel("QAFAC Spend Analysis Rev1.xlsx",'Data')
...
df = pd.read_excel(r"C:\Users\Administrator\Desktop\Dev@Pilog\dash\MYDASH\mydash1\QAFAC Spend Analysis Rev1.xlsx",'Data')
